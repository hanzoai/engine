...
// and once with the force-unfused flag (the proven rms_norm + rope_positions chain). A wrong
...
// f32/f16 reorder, not a layout/scale bug. Run with --test-threads=1 (process-global force flag).
#![cfg(feature = "rocm")]
