...
#[cfg(target_os = "macos")]
const KERNELS: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/hanzo_quant.metallib"));
#[cfg(target_os = "ios")]
const KERNELS: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/hanzo_quant_ios.metallib"));
#[cfg(target_os = "tvos")]
const KERNELS: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/hanzo_quant_tvos.metallib"));
...
impl Kernels {
    ...
    #[allow(clippy::const_is_empty)] // KERNELS can be empty when METAL_PRECOMPILE=0
