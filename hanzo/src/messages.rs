...
pub trait RequestLike {
    ...
    fn code_execution_permission(&self) -> Option<hanzo_engine::CodeExecutionPermission> {
        None
    }
    fn agent_permission(&self) -> Option<hanzo_engine::AgentPermission> {
        None
    }
    fn agent_approval_handler(&self) -> Option<hanzo_engine::AgentToolApprovalHandler> {
        None
    }
...
pub struct RequestBuilder {
    ...
    code_execution_permission: Option<hanzo_engine::CodeExecutionPermission>,
    agent_permission: Option<hanzo_engine::AgentPermission>,
    agent_approval_handler: Option<hanzo_engine::AgentToolApprovalHandler>,
...
impl RequestBuilder {
    ...
    pub fn with_code_execution_permission(
        mut self,
        permission: hanzo_engine::CodeExecutionPermission,
    ) -> Self {
    ...
    pub fn with_agent_permission(mut self, permission: hanzo_engine::AgentPermission) -> Self {
    ...
    where
        F: Fn(hanzo_engine::AgentToolApproval) -> Fut + Send + Sync + 'static,
        Fut: Future<Output = hanzo_engine::AgentToolApprovalDecision> + Send + 'static,
    {
