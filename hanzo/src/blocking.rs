//! Synchronous (blocking) wrappers for the hanzo SDK.
//!
...
//! use hanzo::{IsqBits, TextModelBuilder, TextMessages, TextMessageRole};
//!
...
/// ```no_run
/// # use hanzo::blocking::{BlockingModel, BlockingStream};
/// # use hanzo::*;
