...
//!
//! Run with: `cargo run --release --example multimodal_multiturn -p hanzo`

use anyhow::Result;
use hanzo::{ModelBuilder, MultimodalMessages, RequestBuilder, TextMessageRole};
