...
## HTTP server
You can find this example [here](https://github.com/hanzoai/engine/blob/main/examples/server/gemma3.py).
...
## Python
You can find this example [here](https://github.com/hanzoai/engine/blob/main/examples/python/gemma3.py).
