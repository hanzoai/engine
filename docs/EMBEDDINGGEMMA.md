...
EmbeddingGemma was the first embedding model supported by Hanzo Engine. It generates optimized embeddings for various use cases such as document retrieval, question answering, and fact verification.
...
An example with the OpenAI client can be found [here](https://github.com/hanzoai/engine/blob/master/examples/server/embedding.py).
...
Refer to [this example](https://github.com/hanzoai/engine/blob/master/examples/python/embedding_gemma.py) for a complete runnable script.
