...
Hanzo Engine supports the Llama 3.2 vision model, with examples in the Rust, Python, and HTTP APIs. ISQ quantization is supported to allow running the model with less memory requirements.
...
## HTTP server
You can find this example [here](https://github.com/hanzoai/engine/blob/main/examples/server/llama_vision.py).
...
## Python
You can find this example [here](https://github.com/hanzoai/engine/blob/main/examples/python/llama_vision.py).
