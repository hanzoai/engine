...
- AWQ (convert with [this script](https://github.com/hanzoai/engine/blob/master/scripts/convert_awq_marlin.py))
    - Supported in all plain/multimodal and adapter models
    - CUDA only
    - 4 and 8 bit
    - [Marlin](https://github.com/IST-DASLab/marlin) kernel support in 4-bit and 8-bit.
- HQQ
    - Supported in all plain/multimodal and adapter models via ISQ
    - 4, 8 bit
    - CPU, CUDA, Metal (all supported devices)
- FP8
    - Supported in all plain/multimodal and adapter models
...
- Hanzo Engine will automatically detect and use GPTQ quantization for plain and multimodal models!
...
- Hanzo Engine will automatically detect and use quantization for plain and multimodal models!
