...
Hanzo Engine supports the Qwen2-VL vision model family, with examples in the Rust, Python, and HTTP APIs. ISQ quantization is supported to allow running the model with less memory requirements.
...
## HTTP server
You can find this example [here](https://github.com/hanzoai/engine/blob/main/examples/server/qwen2vl.py).
...
## Python
You can find this example [here](https://github.com/hanzoai/engine/blob/main/examples/python/qwen2vl.py).
