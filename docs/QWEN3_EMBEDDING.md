...
A ready-to-run version can be found at [`examples/python/qwen3_embedding.py`](https://github.com/hanzoai/engine/blob/main/examples/python/qwen3_embedding.py).
