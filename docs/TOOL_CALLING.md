...
LLMs use tool calling to interact with the outside world. Hanzo Engine has OpenAI compatible support for tool calling in all APIs, HTTP, Python, and Rust.
...
Please see [our example here](https://github.com/hanzoai/engine/blob/main/examples/server/tool_calling.py).

> OpenAI docs: https://platform.openai.com/docs/api-reference/chat/create?lang=curl

## Rust example
Please see [our example here](https://github.com/hanzoai/engine/blob/main/mistralrs/examples/advanced/tools/main.rs).

## Python example
Please see [our notebook here](https://github.com/hanzoai/engine/blob/main/examples/python/tool_calling.ipynb).
...
See [custom_search.py](https://github.com/hanzoai/engine/blob/main/examples/python/custom_search.py) for a full
example. In Rust pass `.with_tool_callback(...)` to the builder as demonstrated
in [tool_callback/main.rs](https://github.com/hanzoai/engine/blob/main/mistralrs/examples/advanced/tool_callback/main.rs).
