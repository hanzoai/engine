...
You can access it using the `matformer_config_path` ([example config](https://github.com/hanzoai/engine/blob/master/matformer_configs/gemma3n.csv)) and `matformer_slice_name` arguments throughout the APIs. You can read more about MatFormer in Hanzo Engine [here](MATFORMER.md).

### Available Slices

The default configuration file ([`matformer_configs/gemma3n.csv`](https://github.com/hanzoai/engine/blob/master/matformer_configs/gemma3n.csv)) includes:
