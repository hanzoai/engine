use hanzo_mcp::{Function, Tool, ToolType};
use hanzo_sandbox::{EffectiveProtection, NetworkMode};
use serde_json::json;
use std::collections::HashMap;

use crate::InputModality;

pub const EXECUTE_PYTHON_TOOL_NAME: &str = "hanzo_execute_python";
pub const RESET_SESSION_TOOL_NAME: &str = "hanzo_reset_python_session";
pub const READ_FILE_TOOL_NAME: &str = "hanzo_read_file";
pub const LIST_FILES_TOOL_NAME: &str = "hanzo_list_files";
