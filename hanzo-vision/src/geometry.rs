...
pub fn paste_resized(base: &mut DynamicImage, patch: &DynamicImage, x: u32, y: u32, w: u32, h: u32) {
...
mod tests {
    ...
    fn crop_then_paste_roundtrip_dimensions() {
        ...
        let patch = DynamicImage::ImageRgb8(image::ImageBuffer::from_pixel(16, 16, Rgb([255, 0, 0])));
