...
pub use loaders::{
    ...
    EmbeddingModelPaths, EmbeddingModule, EmbeddingModulePaths, EmbeddingModuleType, FalconLoader,
    FluxLoader, GLM4Loader, GLM4MoeLiteLoader, GLM4MoeLoader, GPT2Loader, Gemma2Loader,
    Gemma3Loader, Gemma3nLoader, Gemma4Loader, GemmaLoader, Glm5MoeLoader, GptOssLoader,
    GraniteMoeHybridLoader, Idefics2Loader, Idefics3Loader, LLaVALoader, LLaVANextLoader,
    LlamaLoader, Loader, LocalModelPaths, MiniCpmOLoader, MiniMaxM2Loader, Mistral3Loader,
    MistralLoader, MixtralLoader, ModelKind, ModelPaths, MultimodalLoaderType, MultimodalModel,
    MultimodalModelLoader, MuseTalkAnimationLoader, MuseTalkComponents, NormalLoaderType,
    NormalLoadingMetadata, NormalModel, NormalModelLoader, OlmoLoader, Phi2Loader, Phi3Loader,
    Phi3VLoader, Phi3_5MoELoader, Phi4MMLoader, PrettyName, QuantizationKind, Qwen2Loader,
    Qwen2VLLoader, Qwen2_5VLLoader, Qwen3EmbeddingLoader, Qwen3Loader, Qwen3MoELoader,
    Qwen3NextLoader, Qwen3OmniLoader, Qwen3VLLoader, Qwen3VLMoELoader, Qwen3_5Loader,
