...
impl Attention {
    fn new(
        ...
        // No TP here.
        let qkv_proj = hanzo_quant::linear_no_bias(
            cfg.hidden_size,
            op_size,
        ...
        let o_proj = hanzo_quant::linear_no_bias(
            num_heads * head_dim,
            cfg.hidden_size,
            &cfg.quantization_config,
            vb.pp("o_proj"),
...
impl Mlp {
    fn new(cfg: &Config, vb: ShardedVarBuilder) -> Result<Self> {
        ...
        // No TP here.
        let gate_up_proj = hanzo_quant::linear_no_bias(
            hidden_size,
            2 * i_size,
            &cfg.quantization_config,
            vb.pp("gate_up_proj"),
        ...
        let down_proj = hanzo_quant::linear_no_bias(
            i_size,
            hidden_size,
            &cfg.quantization_config,
            vb.pp("down_proj"),
...
impl MultimodalModel for Model {
    fn forward(
        ...
        self.forward(input_ids, pixel_values, ctx, image_sizes, &image_hashes)
    }
