...
impl Attention {
    fn new(
        ...
        // No TP here.
        let qkv_proj = hanzo_quant::linear_no_bias_static_lora(
            cfg.hidden_size,
            op_size,
            cfg.loras(),
            vb.pp("qkv_proj"),
        ...
        let o_proj = hanzo_quant::linear_no_bias_static_lora(
            num_heads * head_dim,
            cfg.hidden_size,
            cfg.loras(),
            vb.pp("o_proj"),
...
impl Mlp {
    fn new(cfg: &Phi4MMConfig, vb: ShardedVarBuilder) -> Result<Self> {
        ...
        // No TP here.
        let gate_up_proj = hanzo_quant::linear_no_bias_static_lora(
            hidden_size,
            2 * i_size,
            cfg.loras(),
            vb.pp("gate_up_proj"),
        ...
        let down_proj = hanzo_quant::linear_no_bias_static_lora(
            i_size,
            hidden_size,
            cfg.loras(),
            vb.pp("down_proj"),
