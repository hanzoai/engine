...
use either::Either;
use hanzo_engine::WebSearchOptions;
use pyo3::{
...
pub struct ChatCompletionRequest {
    ...
    pub(crate) code_execution_permission: Option<hanzo_engine::CodeExecutionPermission>,
    pub(crate) agent_permission: Option<hanzo_engine::AgentPermission>,
