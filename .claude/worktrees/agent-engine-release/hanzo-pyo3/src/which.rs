...
impl From<SpeechLoaderType> for hanzo_engine::SpeechLoaderType {
    fn from(value: SpeechLoaderType) -> Self {
        match value {
            SpeechLoaderType::Dia => hanzo_engine::SpeechLoaderType::Dia,
        }
    }
}
...
impl From<IsqOrganization> for hanzo_engine::IsqOrganization {
    fn from(value: IsqOrganization) -> Self {
        match value {
            IsqOrganization::Default => hanzo_engine::IsqOrganization::Default,
            IsqOrganization::MoQE => hanzo_engine::IsqOrganization::MoeExpertsOnly,
        }
    }
}
