...
- [`ring_0.json`](https://github.com/hanzoai/engine/blob/master/ring_configs/ring_0.json):
  ```json
  {
    "master_ip": "0.0.0.0",
    "master_port": 1234,
...
- [`ring_1.json`](https://github.com/hanzoai/engine/blob/master/ring_configs/ring_1.json):
  ```json
  {
    "master_ip": "0.0.0.0",
    "master_port": 1234,
