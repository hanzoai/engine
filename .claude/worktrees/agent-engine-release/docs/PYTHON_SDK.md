...
Full API reference: [here](https://hanzoai.github.io/engine/pyo3/hanzo.html)
...
Adapter variants (`XLora`, `Lora`, `XLoraGGUF`, `LoraGGUF`, `GGML`, `XLoraGGML`, `LoraGGML`) are also available. See the [full API reference](https://hanzoai.github.io/engine/pyo3/hanzo.html) for details.
...
| Category | Examples |
|---|---|
| **Getting Started** | [plain.py](https://github.com/hanzoai/engine/blob/master/examples/python/plain.py), [streaming.py](https://github.com/hanzoai/engine/blob/master/examples/python/streaming.py), [gguf.py](https://github.com/hanzoai/engine/blob/master/examples/python/gguf.py) |
| **Structured Output** | [pydantic_schema.py](https://github.com/hanzoai/engine/blob/master/examples/python/pydantic_schema.py), [json_schema.py](https://github.com/hanzoai/engine/blob/master/examples/python/json_schema.py), [regex.py](https://github.com/hanzoai/engine/blob/master/examples/python/regex.py), [lark.py](https://github.com/hanzoai/engine/blob/master/examples/python/lark.py) |
| **Tool Calling** | [tool_call.py](https://github.com/hanzoai/engine/blob/master/examples/python/tool_call.py), [custom_tool_call.py](https://github.com/hanzoai/engine/blob/master/examples/python/custom_tool_call.py), [agentic_tools.py](https://github.com/hanzoai/engine/blob/master/examples/python/agentic_tools.py) |
| **Search** | [web_search.py](https://github.com/hanzoai/engine/blob/master/examples/python/web_search.py), [custom_search.py](https://github.com/hanzoai/engine/blob/master/examples/python/custom_search.py) |
| **MCP** | [mcp_client.py](https://github.com/hanzoai/engine/blob/master/examples/python/mcp_client.py) |
| **Quantization** | [isq.py](https://github.com/hanzoai/engine/blob/master/examples/python/isq.py), [imatrix.py](https://github.com/hanzoai/engine/blob/master/examples/python/imatrix.py), [topology.py](https://github.com/hanzoai/engine/blob/master/examples/python/topology.py) |
| **Adapters** | [lora_zephyr.py](https://github.com/hanzoai/engine/blob/master/examples/python/lora_zephyr.py), [xlora_zephyr.py](https://github.com/hanzoai/engine/blob/master/examples/python/xlora_zephyr.py), [anymoe.py](https://github.com/hanzoai/engine/blob/master/examples/python/anymoe.py) |
| **Advanced** | [paged_attention.py](https://github.com/hanzoai/engine/blob/master/examples/python/paged_attention.py), [speculative.py](https://github.com/hanzoai/engine/blob/master/examples/python/speculative.py), [multi_model_example.py](https://github.com/hanzoai/engine/blob/master/examples/python/multi_model_example.py) |
| **Cookbook** | [cookbook.ipynb](https://github.com/hanzoai/engine/blob/master/examples/python/cookbook.ipynb), [tool_calling.ipynb](https://github.com/hanzoai/engine/blob/master/examples/python/tool_calling.ipynb) |

Browse all examples: [examples/python/](https://github.com/hanzoai/engine/tree/master/examples/python)
