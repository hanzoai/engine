...
pub struct AgenticDefaults {
    ...
    pub agent_permission: Option<hanzo_engine::AgentPermission>,
...
fn init_router(
    ...
    let router = Router::new()
        ...
        .route("/v1/engine/chat/completions", post(chatcompletions))
        .route("/v1/engine/completions", post(completions))
        .route("/v1/engine/embeddings", post(embeddings))
        .route("/v1/engine/models", get(models))
        .route("/v1/engine/responses", post(create_response))
