...
///
/// ```no_run
/// use hanzo_server_core::chat_completion::ChatCompletionOnChunkCallback;
///
...
///
/// ```no_run
/// use hanzo_server_core::chat_completion::ChatCompletionOnDoneCallback;
///
...
fn stamp_file_ids(records: &mut [AgenticToolCallRecord], files: &[hanzo_engine::File]) {
...
pub async fn process_non_streaming_response(
    ...
    let mut files: Vec<hanzo_engine::File> = Vec::new();
